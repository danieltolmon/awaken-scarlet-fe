              ...
              <div className="bg-primary/80 shadow-two border-black border-solid rounded-2xl flex  justify-between flex-row flex-wrap cursor-pointer">
                <div className="p-5 xl:p-8 w-full md:w-1/2 flex flex-col justify-between">
                  ...
                  <div className='flex gap-4 mb-4'>
                    ...
                    {session.booking &&
                      <Link href='/booking' className="bg-primary py-2 px-5 border border-solid border-gray-300 rounded-md gap-2 text-xs text-white font-semibold flex items-center justify-between transition-all duration-500 hover:bg-white/5">
                        Book
                      </Link>}
                  </div>
